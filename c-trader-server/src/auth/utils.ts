 ...
 */
export let randomBase64URLBuffer = (len) => {
    len = len || 32;
 ...
 */
export let generateServerMakeCredRequest = (username, displayName, id) => {
    return {
...
export let verifyAuthenticatorAttestationResponse = (webAuthnResponse) => {
...
export let verifyAuthenticatorAssertionResponse = (webAuthnResponse, authenticators) => {
